//! This is an almost line-by-line translation from the hashers' test from Django 5.0:
...
fn test_low_level_pbkdf2() {
    ...
    assert_eq!(
        encoded,
        "pbkdf2_sha256$720000$seasalt2$e8hbsPnTo9qWhT3xYfKWoRth0h0J3360yb/tipPhPtY=",
    );
    assert_eq!(check_password("lètmein", &encoded), Ok(true));
}
...
fn test_low_level_pbkdf2_sha1() {
    ...
    assert_eq!(
        encoded,
        "pbkdf2_sha1$720000$seasalt2$2DDbzziqCtfldrRSNAaF8oA9OMw="
    );
    assert_eq!(check_password("lètmein", &encoded), Ok(true));
}
